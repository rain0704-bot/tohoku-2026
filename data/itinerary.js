window.ORIGINAL_ITINERARY = {
  ...
  days: [
    ...
    },
    {
      ...
      items: [
        {
          id: "day2-sample-attraction",
          type: "attraction",
          period: "上午",
          name: "示範景點",
          japaneseName: "サンプル観光地",
          priority: "optional",
          status: "active",
          description: "用來測試景點卡片與導航按鈕。",
          googleMapsUrl: "https://www.google.com/maps",
          mapCode: "000 000 000*00",
          parking: "待確認",
          walking: "約 10 分鐘",
          stairs: "少量",
          toilet: "待確認",
        ...
        {
          id: "day2-sample-lunch",
          type: "restaurant",
          period: "午餐",
          name: "示範午餐",
          japaneseName: "サンプルランチ",
          priority: "removable",
          status: "active",
          description: "用來測試餐廳資料。",
          phone: "+81-22-111-1111",
          price: "待確認",
          childNote: "確認是否有小孩可接受的餐點。"
        }
      ]
    },
    {
